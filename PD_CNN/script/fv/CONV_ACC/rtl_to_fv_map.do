...
# Generated on: Tue Feb 04 23:05:59 IST 2025 (Tue Feb 04 17:35:59 UTC 2025)
...
set_log_file fv/CONV_ACC/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/CONV_ACC -revised fv_map
...
add_search_path . /mnt/cadence_tools/GENUS211/tools.lnx86/lib/tech -library -both
read_library -liberty -both /home/siddhanth/PD_project_CNN/script/../lib/slow.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../src/CONV_ACC.v
elaborate_design -golden -root {CONV_ACC} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/CONV_ACC/fv_map.v.gz
elaborate_design -revised -root {CONV_ACC}
...
#add_name_alias fv/CONV_ACC/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/CONV_ACC/rtl_to_fv_map.log
}
